  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className='text-error'>{(errors.familyName as any)?.message ?? (errors.givenName as any)?.message}</p>
      </div>
      ...
      <div>
        ...
        <p className='text-error'>{(errors.familyNameKana as any)?.message ?? (errors.givenNameKana as any)?.message}</p>
      </div>
      ...
      <div>
        ...
        <p className='text-error'>{(errors.message as any)?.message}</p>
      </div>
